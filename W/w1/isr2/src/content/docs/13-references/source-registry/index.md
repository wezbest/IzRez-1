...
description: "The 1764 primary sources discovered during the research source-expansion phase, grouped into seven institutional categories and cross-linked to the sections that cite them."
---

<div class="sec-head">
<span class="chip chip-kind">Source Registry</span>
<span class="chip">1,764 entries</span>
...
<a href="/13-references/reference-index/">→ Jump to the collected reference index (§13.1)</a>
