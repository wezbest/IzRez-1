...
```mermaid
graph TD
    A[Migrant Sender: Deprecating Correspondent Banking] --> B[Legacy Rails: SWIFT Delays 2-4 Days + 5-15% Fees]
    B --> C[Informal Hawala: Unregulated, Seizure Risk]
    D[SiratRemit Fiat In: AED via Licensed Local Partner] --> E[Under-the-Hood Settlement: Shariah-Screened USDC]
    E --> F[Automated Reserve-Riba Purification Engine]
    F --> G[SiratRemit Fiat Out: Instant PKR to JazzCash Wallet]
    G --> H[Landed in 8 Minutes at < 1% All-In Cost]
```
...
```mermaid
pie title Transaction Fee Distribution ($1.90 Revenue)
    "Net Operating Profit" : 0.85
    "Local Fiat Payout (Destination)" : 0.40
    "Wholesale On-Ramp Fee" : 0.30
    "Fiat Ingestion Fee (Sender)" : 0.25
    "Blockchain Gas & Tech Ops" : 0.09
...
```mermaid
graph LR
    A[Corridor-Specific SSB Comfort Letters] --> B[Rented-Rails VASP & Banking Partnerships]
    B --> C[Automated Real-Time Purification Ledger]
    C --> D[Massive Landed-Cost Pricing Advantage]
...
```mermaid
gantt
    title SiratRemit 90-Day Launch Roadmap (UAE -> Pakistan Corridor)
    dateFormat  YYYY-MM-DD
    section Days 1-30: Rented-Rails Setup
    Execute API Integration Agreement with Licensed UAE VASP :done, des1, 2026-10-01, 2026-10-20
    Execute Off-Ramp API Agreement with Pakistan Exchange Co :done, des2, 2026-10-20, 2026-10-31
    section Days 31-60: Community Seeding
    Recruit 10 Community Champions in Sonapur Labour Accommodation :active, des3, 2026-11-01, 2026-11-20
    Publish Urdu Explainer Video on Shariah Permissibility :active, des4, 2026-11-20, 2026-11-30
    section Days 61-90: Live Corridor Beta
    Launch $25k Closed-Loop Transfer Beta (100 Users) :des5, 2026-12-01, 2026-12-20
    Scale to 1,000 Organic Monthly Transfers :des6, 2026-12-21, 2026-12-31
```
...
```mermaid
graph TD
    A[Primary Model: Consumer Mobile Remittance App] -->|Failure Mode: PVARA / VASP Regulatory Crackdown| B[Pivot Option 1: B2B Gulf-to-Asia SME Contractor Payouts]
    A -->|Failure Mode: Fatwa Backlash on Consumer Crypto| C[Pivot Option 2: Shariah Screening Oracle API for Exchanges]
    A -->|Failure Mode: Destructive Corridor Price War| D[Pivot Option 3: Wakalah Spare-Change Sukuk Micro-Savings]
    A -->|Failure Mode: South Asian Capital Account Freeze| E[Pivot Option 4: Closed-Loop Diaspora Utility Bill Vouchers]
```
...
- World Bank: *Remittance Prices Worldwide (RPW) Quarterly Report* [2026](https://remittanceprices.worldbank.org/sites/default/files/2026-04/RPW_main_report_and_annex_Q325.pdf) <a class="xref" href="/13-references/source-registry/#r596" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Allium Financial: *Stablecoins in Cross-Border Payments: Volume & Growth Metrics 2025/2026* [2026](https://www.allium.so/reports/stablecoins-cross-border-payments-2026) <a class="xref" href="/13-references/cited-sources/#ref-h7zr02" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
...
- Virtual Assets Regulatory Authority (VARA, Dubai): *Virtual Asset Issuance Rulebook & Framework* [2026](https://cryptoslate.com/crypto-laws/vara-virtual-asset-issuance-rulebook/) <a class="xref" href="/13-references/cited-sources/#ref-twb3vq" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Business Standard: *Fintech Platform Endl Secures $1.5 Million Investment to Scale Cross-Border Stablecoin Rails* [2026](https://www.business-standard.com/content/press-releases-ani/fintech-platform-endl-secures-1-5-million-dollar-investment-to-scale-global-payment-infrastructure-126021300860_1.html) <a class="xref" href="/13-references/cited-sources/#ref-3i3lbq" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- The Digital Banker: *Fasset Secures Provisional Banking License to Launch World's First Stablecoin Islamic Bank* [2025](https://thedigitalbanker.com/fasset-secures-provisional-banking-license-to-become-worlds-first-stablecoin-powered-islamic-bank/) <a class="xref" href="/13-references/cited-sources/#ref-t2u7b5" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Dewan Syariah Nasional - MUI (Indonesia): *Fatwa on Cryptocurrency as a Digital Asset and Medium of Exchange* [2025](https://fatwamui.com/storage/614/HUKUM-CRYPTOCURRENCY.pdf) <a class="xref" href="/13-references/cited-sources/#ref-07lckg" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Frasat Partners: *PVARA Pakistan Virtual Assets Regulatory Authority Complete Legal Guide* [2026](https://www.frasatpartners.com/articles/pvara-pakistan-virtual-assets-regulatory-authority-complete-legal-guide-2026) <a class="xref" href="/13-references/cited-sources/#ref-997ld8" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- State Bank of Pakistan: *Circular Letter No. 10 Regarding Bank Accounts for Virtual Asset Service Providers* [2026](https://www.sbp.org.pk/circulars/bprd-circular-letter-no-10) <a class="xref" href="/13-references/source-registry/#r968" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- 4IRE Labs: *Shariah-Compliant DeFi and Stablecoin Structuring Principles* [2025](https://4irelabs.com/articles/shariah-compliant-defi/) <a class="xref" href="/13-references/cited-sources/#ref-me5l36" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
