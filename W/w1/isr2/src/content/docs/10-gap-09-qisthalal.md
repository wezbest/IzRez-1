---
title: "10 · Gap 09 — QistHalal"
description: "graph TD"
---

<div class="sec-head">
<span class="chip chip-kind acc-spring">Gap Blueprint</span>
<span class="chip">Section 10 of 14</span>
<span class="chip">5,468 words</span>
...
```mermaid
graph TD
    A[Muslim Consumer Needs Vehicle or Retail Installments] --> B[Conventional Market: PCP / HP Loan + Compounding APR]
    B --> C[Theological Violation: Riba al-Qard = Forbidden]
    C --> D[Result: Cash-or-Nothing Exclusion]
    E[QistHalal: Certified Murabaha BNPL & Lease-to-Own Ijara] --> F[Asset Ownership Borne by Funder + Fixed Rentals]
    F --> G[100% Interest-Free with Verified Charity Late-Fee Purification]
    G --> H[Empowered Diaspora & Scalable Venture Economics]
```
...
```mermaid
pie title Revenue Composition ($275.3k Cohort Revenue)
    "Merchant SaaS Subscriptions" : 124200
    "BNPL Merchant Discount Rates (3.8%)" : 68400
    "Auto Lease Brokerage Fees (2.0%)" : 60000
...
```mermaid
gantt
    title QistHalal 90-Day Launch Roadmap (UK Diaspora Wedge)
    dateFormat  YYYY-MM-DD
    section Days 1-30: Dealer Partnerships
    Sign Pilot MoUs with 5 Halal Dealerships in Birmingham :done, des1, 2026-10-01, 2026-10-20
    Execute Appointed Representative Agreement with FCA Partner :done, des2, 2026-10-20, 2026-10-31
    section Days 31-60: Community Distribution
    Partner with Birmingham Private-Hire Taxi Drivers Assoc :active, des3, 2026-11-01, 2026-11-20
    Launch TikTok/YouTube Educational Campaign on PCP vs Ijara :active, des4, 2026-11-20, 2026-11-30
    section Days 61-90: Live Origination
    Fund First 25 Vehicle Leases via Partner Balance Sheet :des5, 2026-12-01, 2026-12-20
    Deploy Shopify Checkout Widget to 20 Modest-Fashion Merchants :des6, 2026-12-21, 2026-12-31
```
...
```mermaid
graph TD
    A[Primary Model: Integrated Consumer BNPL + Auto Ijara Platform] -->|Failure Mode: FCA Credit Licensing Freeze| B[Pivot Option 1: Shariah Audit & Contract SaaS for Lenders]
    A -->|Failure Mode: Retail Auto Credit Default Spike| C[Pivot Option 2: Commercial B2B Fleet Leasing for Taxis]
    A -->|Failure Mode: Warehouse Debt Facility Cancellation| D[Pivot Option 3: Cross-Border Diaspora Remittance-to-Asset]
    A -->|Failure Mode: UK Consumer Duty Compliance Burden| E[Pivot Option 4: Merchant-Own DPC Enablement SaaS]
```
...
- Synapse Analytics: *Buy-Now-Pay-Later in MENA & GCC: Market Dynamics & Growth Drivers* [2025](https://synapse-analytics.io/blog/bnpl-in-mena-gcc-growth-drivers-market-dynamics-and-the-road-ahead) <a class="xref" href="/13-references/cited-sources/#ref-9daxmc" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Financial Conduct Authority (FCA, UK): *Policy Statement PS26/1: Regulation of Deferred Payment Credit (DPC)* [2026](https://www.fca.org.uk/publications/policy-statements/ps26-1-regulation-deferred-payment-credit) <a class="xref" href="/13-references/source-registry/#r946" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- FinTech Global: *Tabby Closes $233M Series F at $6.5B Valuation as It Pushes Beyond BNPL* [2026](https://fintech.global/2026/09/14/tabby-raises-233m-at-6-5bn-valuation/) <a class="xref" href="/13-references/cited-sources/#ref-lln7lg" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Tamara Corporate News: *Tamara Secures Landmark $2.4 Billion Shariah-Compliant Financing Facility* [2025](https://tamara.co/en-sa/blog-post/tamara-secures-up-to-2-4-billion-dollar-facility) <a class="xref" href="/13-references/source-registry/#r1396" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- The Intermediary: *Triple Point Provides £75 Million Senior Shariah-Compliant Facility for Ayan Capital* [2026](https://theintermediary.co.uk/2026/09/triple-point-provides-75m-shariah-compliant-facility-for-ayan-capital/) <a class="xref" href="/13-references/cited-sources/#ref-9wk6tt" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Kandoo Finance: *No-Interest Car Finance: Navigating Halal Auto Purchase in the UK* [2025](https://www.kandoo.co.uk/guides/no-interest-car-finance-for-muslims) <a class="xref" href="/13-references/cited-sources/#ref-mblnyf" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- SeekersGuidance: *Is Personal Contract Purchase (PCP) Considered Riba or a Permissible Lease in Islamic Law?* [2025](https://seekersguidance.org/answers/transactions-shafii-fiqh/is-pcp-car-finance-considered-interest-or-a-permissible-lease-in-islam/) <a class="xref" href="/13-references/cited-sources/#ref-q1gxi0" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Central Bank of Bahrain: *Consultation on Proposed Buy-Now-Pay-Later Module (Volume 5)* [2025](https://www.cbb.gov.bh/wp-content/uploads/2025/11/Consultation_Proposed-Buy-Now-Pay-Later-Module.pdf) <a class="xref" href="/13-references/source-registry/#r925" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- White & Case: *UAE Central Bank Introduces Regulatory Framework for Buy-Now-Pay-Later Providers* [2025](https://www.whitecase.com/insight-alert/uae-central-bank-introduces-regulatory-framework-buy-now-pay-later-providers) <a class="xref" href="/13-references/cited-sources/#ref-30vszu" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
- Waya Media: *Bahrain's Flooss Secures $22 Million Credit Facility to Scale Sharia Consumer Finance* [2026](https://waya.media/bahrains-flooss-secures-usd-22m-credit-facility-to-scale-consumer-finance/) <a class="xref" href="/13-references/cited-sources/#ref-1fb0am" title="Open this source's row in the reference ledger">index&nbsp;↗</a>
